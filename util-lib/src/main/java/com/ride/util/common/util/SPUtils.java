...
public class SPUtils {
    ...
    private static String sDefaultSharedPreferencesName;
    private SharedPreferences sp;

    static {
        sDefaultSharedPreferencesName = Utils.getContext().getPackageName() + "_preferences";
    }
    ...
    public static SPUtils getInstance() {
        return getInstance(sDefaultSharedPreferencesName);
    }
    ...
    public static SPUtils getInstance(String spName) {
        if (isSpace(spName)) {
            spName = sDefaultSharedPreferencesName;
        }
