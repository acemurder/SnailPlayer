package com.ride.snailplayer.widget.scrollview;
...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
    ...
    public PullToZoomScrollViewEx(Context context, AttributeSet attrs) {
        ...
        ((ObservableScrollView) mRootView).addOnScrollViewChangedListener(new OnScrollViewScrollChangeListener() {
            @Override
    ...
    protected ScrollView createRootView(Context context, AttributeSet attrs) {
        ScrollView scrollView = new ObservableScrollView(context, attrs);
    ...
    private final class ScalingRunnable implements Runnable {
        long mDuration;
    ...
    public static class ObservableScrollView extends ScrollView {
        ...
        private List<OnScrollViewScrollChangeListener> mListeners;
        ...
        public void addOnScrollViewChangedListener(@NonNull OnScrollViewScrollChangeListener listener) {
        ...
        protected void onScrollChanged(int l, int t, int oldl, int oldt) {
            ...
            for (int i = 0; i < mListeners.size(); i++) {
                mListeners.get(i).onScrollChanged(l, t, oldl, oldt);
            }
        }
    }

    public interface OnScrollViewScrollChangeListener {
